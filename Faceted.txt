...
def init_lighting():
    ...
    glShadeModel(GL_FLAT)  # <<< FACETED SHADING (FLAT)
    ...
    glMaterialfv(GL_FRONT, GL_DIFFUSE, [0.8, 0.2, 0.2, 1])  # Red object
...
def main():
    ...
    glutCreateWindow(b"Faceted (Flat) Shading - PyOpenGL")
